...
int main(void)
{
    ...
    if(month >= 1 && month <= 12)
    {
        if(month <= 2) printf("The season is winter\n");
        else if(month <= 5) printf("The season is spring\n");
        else if(month <= 8) printf("The season is summer\n");
        else if(month <= 11) printf("The season is autumn\n");
